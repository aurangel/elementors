...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Обзор приложения","Начало работы","Основные приемы работы","О программе Elementors ARM","Главное окно приложения","Главная вкладка приложения","Создание новой таблицы","Изменение данных таблицы","Взаимодействие с документами","Дизайнер отчетов","Информация о преподавателе","Быстрый поиск","Управление несколькими таблицами","Предпросмотр отчета","Практическое руководство"],
	DREX_NODE_LINKS: ["obzor_prilozheniya.html","nachalo_raboty.html","osnovnye_priemy_raboty.html","o_programme_elementors_arm.html","glavnoe_okno_prilozheniya.html","glavnaya_vkladka_prilozheniya.html","sozdanie_novoj_tablitsy.html","izmenenie_dannykh_tablitsy.html","vzaimodejstvie_s_dokumentami.html","dizajner_otchetov.html","informatsiya_o_prepodavatele.html","bystryj_poisk.html","upravlenie_neskolkimi_tablitsami.html","predprosmotr_otcheta.html","prakticheskoe_rukovodstvo.html"],
	DREX_NODE_CHILD_START: [1,3,6,12,12,12,12,13,13,14,15,15,15,15,15],
	DREX_NODE_CHILD_END: [3,6,12,12,12,12,13,13,14,15,15,15,15,15,15],
	DREX_MENU_TYPE: 3,
